...
class SaveCertificatesPage extends StatefulWidget {
...
class _SaveCertificatesPageState extends State<SaveCertificatesPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    apiManager.addCertificate(widget.formData).then((result) {
