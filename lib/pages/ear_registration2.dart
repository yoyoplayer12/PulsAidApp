...
class EarRegistration2Page extends StatefulWidget {
  const EarRegistration2Page({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _EarRegistrationPage2State createState() => _EarRegistrationPage2State();
}

class _EarRegistrationPage2State extends State<EarRegistration2Page> {
                            ...
                            SizedBox(
                              ...
                              onTap: checkFieldsAndNavigate,
                                child: ElevatedButtonBlue(
                                  ...
                                  _allChecked
                                    ? () {
                                      Navigator.pushNamed(context, '/ear_registration3');
                                    } : null,
                                  arrow: true,
                                  textleft: true,
                                  child: Builder(
